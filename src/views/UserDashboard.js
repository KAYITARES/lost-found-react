      ...
      >
        ...
        <center>
          ...
          >
            ...
            <Form.Item label="Picture of Document" name="Picturesofdocs">
              <Upload>
                <Button
                  icon={<UploadOutlined />}
                  style={{ width: 250, marginLeft: "50px" }}
        ...
        <HomeLayout>
              ...
              <ul>
                ...
                <li>
                  <a href="#" onClick={() => setVisible(true)}>
                    REGISTER LOST DOCUMENT
                  </a>
                </li>
                <li>
                  <a href="/user/allDocument">ALL DOCUMENT</a>
                </li>
          ...
          <div className="text-box">
            <h1 className="heading-primary">
              <span className="heading-primary-main">clemence</span>
              <span className="heading-primary-sub userParagraph">
                Now your can click on register button to fill your Lost Document
              </span>
            </h1>
            <a
              href="#"
